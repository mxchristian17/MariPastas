    ...
    return (
        <div className="flex justify-between items-center relative container md:px-20 mt-10 min-w-72">
            <div className="group flex flex-row flex-wrap relative mb-32 ">
                <div className="mb-7 md:mb-0 xl:w-2/5 xl:mx-0 mx-5 flex m-auto justify-around bg-gray-200 aspect-w-1 aspect-h-1 rounded-[55px] overflow-hidden group-hover:opacity-75 lg:h-full  lg:aspect-none  shadow-lg shadow-slate-500">
                ...
                <div className="my-2 xl:w-3/5 flex justify-between">
