        ...
        <div id="footer" className="bg-gray-200 fixed bottom-0  w-full">
            <div className="textoDorado inset-y-0  grid grid-cols-3 align-center sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <div className="flex p-1 align-center my-auto">
                    ...
                    <a href="https://www.instagram.com/piattipastas/" className='mx-2 xl:mx-4 text-lg hover:text-stone-600 focus:outline-none xl:text-2xl'><FaInstagram/></a>
                    <a href="https://www.facebook.com/piattipastas/" className='mx-2 xl:mx-4 text-lg hover:text-stone-600 focus:outline-none xl:text-2xl'><FaFacebook/></a>
                </div>
