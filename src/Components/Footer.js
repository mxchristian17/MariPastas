        ...
        <div id="footer" className="bg-gray-200 relative bottom-0 w-full">
            <div className="textoDorado inset-y-0  grid grid-cols-3 align-center sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <div className="flex p-1 align-center my-auto">
                    <a href="mailto:piattipastas@gmail.com"><FiMail className='mx-2 xl:mx-4 text-lg hover:text-stone-600 focus:outline-none xl:text-2xl' /></a>
                    <a href="https://api.whatsapp.com/send?phone=5493467499337"><FaWhatsapp className='mx-2 xl:mx-4 text-lg hover:text-stone-600 focus:outline-none xl:text-2xl' /></a>
                    ...
                    <a href="https://www.facebook.com/piattipastas/"><FaFacebook className='mx-2 xl:mx-4 text-lg hover:text-stone-600 focus:outline-none xl:text-2xl' /></a>
                </div>
