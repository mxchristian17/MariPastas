...
const products = [
    {
        ...
        comentario: "Riquìsimos, equilibrados y con excelente sabor",
        comentario2: "Mantener refrigerado en heladera (1-8ºC) 15 días desde la fecha de elaboración. Si congelaste la pasta se puede cocinar directamente. Duración en Freezer (-18ºC) hasta 3 meses a partir de su fecha de vencimiento. Una vez abierto consumir dentro de las 24 horas.",
    ...
    },
    {
        ...
        comentario: "Una exquisita solución para todas tus comidas. Fáciles de preparar, elegí la salsa que quieras.",
        comentario2: "Mantener refrigerado en heladera (1-8ºC) 15 días desde la fecha de elaboración. Si congelaste la pasta se puede cocinar directamente. Duración en Freezer (-18ºC) hasta 3 meses a partir de su fecha de vencimiento. Una vez abierto consumir dentro de las 24 horas.",
        presentacion: "500 GRAMOS.",
